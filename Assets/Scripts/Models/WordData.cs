...
[Serializable] public class WordData {
    /// <summary>The word as a string</summary>
    public string Word => word.ToLower();
    [SerializeField] private string word;
    /// <summary>The type of word (noun, verb, adjective, etc.)</summary>
    public WordType Type => type;
    [SerializeField] private WordType type;
    /// <summary>The category of the word (animals, food, technology, etc.)</summary>
    public string Category => category;
    [SerializeField] private string category;
    /// <summary>A list of synonyms for the word</summary>
    public List<string> Synonyms => synonyms;
    [SerializeField] private List<string> synonyms;
    /// <summary>A list of antonyms for the word</summary>
    public List<string> Antonyms => antonyms;
   [SerializeField] private List<string> antonyms;
    /// <summary>A list of related words</summary>
